...
| **Latencia Media por Consulta** | 452.88 ms | 823.00 ms | +370.12 ms |
...
2. **Evaluación de Latencia:**
   El modelo fine-tuned presenta una latencia media de **452.88 ms**, mientras que el pipeline RAG requiere **823.00 ms** debido a la etapa adicional de búsqueda vectorial y reranking.
